...
# $Header: /var/cvsroot/gentoo-x86/media-sound/mpd/mpd-0.13.2.ebuild,v 1.7 2008/11/07 10:29:17 armin76 Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/flac_replaygain_fix.patch || die "epatch for FLAC ReplayGain fix failed"
}
