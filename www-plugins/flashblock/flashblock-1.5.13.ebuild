...
DESCRIPTION="Replaces Flash objects with a button you can click to view them."
HOMEPAGE="http://flashblock.mozdev.org/"
SRC_URI="http://downloads.mozdev.org/flashblock/${P}.xpi"
...
pkg_postinst() {
	elog "Flashblock has been installed for the following packages:"
	for i in ${mozillas}; do
		elog "  $i"
	done
	elog
	elog "After installing other mozilla ebuilds, if you want to use Flashblock with them"
	elog "reinstall www-plugins/flashblock"
}
