...
# $Header: /var/cvsroot/gentoo-x86/net-fs/samba-server/samba-server-3.4.4-r1.ebuild,v 1.1 2010/01/07 20:37:38 patrick Exp $
...
src_prepare() {
	...
	epatch \
		...
		"${FILESDIR}/samba-3.4.4-cups-encrypt.patch"
